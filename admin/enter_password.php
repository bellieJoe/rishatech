                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Update Now your Password</h1>
                                    </div>
                                    <form action="./enterpword" method="POST" class="user">
                                    ...
                                    <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" name="repeat_new_password" placeholder="Repeat New Password...">
                                        </div>
                                        
                                        <button class="btn btn-primary btn-user btn-block" name="update_password">Update Password</button>
                                        <hr>
