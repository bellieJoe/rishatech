...
$customers = $db->getCustomersWithActiveCredits();
...
<head>
    <title>Customers with active credits</title>
...
<body>
    <div class="container mt-5">
        ...
        <h2>Customers w/ Active Credits</h2>
        ...
        <div id="printableReport">
            <div class="mb-3">
                ...
                <h4 class="text-center font-weight-bold">LIST OF CUSTOMERS W/ ACTIVE CREDITS</h4>
            </div>
            <table class="table table-bordered border">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Active Credits</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
