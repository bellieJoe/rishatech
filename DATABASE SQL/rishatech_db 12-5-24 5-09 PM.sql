...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2024 at 10:09 AM
...
(2, 1, 'Tupperware Lunch Bundle', 17, 300, 2, 'Bundle', 'Available'),
(3, 1, 'JBL Speaker', 18, 2500, 17, 'pc/s', 'Available'),
(6, 3, 'Hanabishi Electric Fan', 18, 4000, 16, 'pc/s', 'Available'),
(7, 1, 'Dowell Washing Machine', 18, 9900, 8, 'pc/s', 'Available'),
(8, 1, 'Sofa Set', 19, 11000, 7, 'pc/s', 'Available');
...
INSERT INTO `customers` (`id`, `admin_id`, `user_id`, `full_name`, `complete_address`, `municipality`, `barangay`, `street_name`, `email`, `phone_number`, `age`, `civil_status`, `citizenship`, `name`) VALUES
(1, 1, NULL, 'SAMPLE', 'SAMPLE', 'Gasan', 'SAMPLE', 'SAMPLE', 'SAMPLE@MAIL.COM', '09121345678', 21, 'Single', 'SAMPLE', ''),
(10, 1, NULL, 'Von Brix L. Lacdao', 'Ino, Mogpog, Marinduque', 'Mogpog', 'Ino', 'c5', 'brixlacdao10@gmail.com', '09121245345', 22, 'Married', 'Filipino', ''),
(11, 1, NULL, 'Norie L. De la Cruz', 'Barangay Quatro, Buenavista, Marinduque', 'Buenavista', 'Barangay III', 'Purok 4', 'noriedelacruz@gmail.com', '09243246456', 22, 'Single', 'Filipino', ''),
(12, 1, NULL, 'Beneden Logmao', 'Mogpog, Marinduque', 'Mogpog', 'Janagdong', 'Purok 4', 'beneden@gmail.com', '09432567689', 20, 'Married', 'Filipino', ''),
(13, 1, NULL, 'Joan Logmao', 'Mogpog Marinduque', 'Mogpog', 'Dawis', 'test street', 'bellie@hulas.co', '09123658794', 21, 'Single', 'sff', ''),
(15, 1, 2, 'Steve Rogers', 'Poras Boac Marinduque', 'Boac', 'Poras', 'Sanggumay St.', 'steverogers@hulas.co', '09493131426', 21, 'Single', 'Filipino', '');
...
(83, 22, 12, '2024-12-28', 1888, 'PAID'),
(84, 22, 12, '2025-01-28', 1982, 'LATE PAID'),
(85, 22, 12, '2025-02-28', 1888, 'PAID'),
(86, 22, 12, '2025-03-28', 1888, 'PAID'),
(87, 22, 12, '2025-04-28', 1888, 'PAID'),
(88, 22, 12, '2025-05-28', 1888, 'PAID'),
(89, 23, 12, '2024-12-28', 0, ''),
(90, 23, 12, '2025-01-28', 0, ''),
(91, 23, 12, '2025-02-28', 0, ''),
(92, 23, 12, '2025-03-28', 0, ''),
(93, 23, 12, '2025-04-28', 0, ''),
(94, 23, 12, '2025-05-28', 0, ''),
(95, 26, 10, '2024-12-29', 0, ''),
(96, 26, 10, '2025-01-29', 0, ''),
(97, 26, 10, '2025-03-01', 0, ''),
(98, 26, 10, '2025-03-29', 0, ''),
(99, 26, 10, '2025-04-29', 0, ''),
(100, 26, 10, '2025-05-29', 0, '');
...
INSERT INTO `discount_promotion` (`id`, `admin_id`, `name`, `type_of_discount`, `downpayment_percentage`, `interest_percentage`, `eligible`, `start_date`, `end_date`, `terms`) VALUES
(1, 1, 'Pay day sale', 'Promotion', '0.2', '0.1', 'all customers', '2024-11-30', '2024-12-30', '12'),
(2, 1, '0% Interest Promo', 'Discount', '0.2', '0.2', 'all customers', '2024-11-29', '2024-11-30', '12'),
(3, 1, 'One Day BigTime Sale', 'Promotion', '0', '0.03', 'All Customers', '2024-11-28', '2024-12-28', '');
