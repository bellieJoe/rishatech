...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2024 at 05:28 AM
...
(3, 1, 3, 'JBL Speaker', 18, 2500, 17, 'pc/s', 'Available'),
(6, 3, 5, 'Hanabishi Electric Fan', 18, 4000, 16, 'pc/s', 'Available'),
(7, 1, 4, 'Dowell Washing Machine', 18, 9900, 8, 'pc/s', 'Available'),
...
INSERT INTO `customers` (`id`, `admin_id`, `user_id`, `credit_limit`, `full_name`, `complete_address`, `municipality`, `barangay`, `street_name`, `email`, `phone_number`, `age`, `civil_status`, `citizenship`, `name`) VALUES
(1, 1, NULL, 0, 'SAMPLE', 'SAMPLE', 'Gasan', 'SAMPLE', 'SAMPLE', 'SAMPLE@MAIL.COM', '09121345678', 21, 'Single', 'SAMPLE', ''),
(10, 1, NULL, 0, 'Von Brix L. Lacdao', 'Ino, Mogpog, Marinduque', 'Mogpog', 'Ino', 'c5', 'brixlacdao10@gmail.com', '09121245345', 22, 'Married', 'Filipino', ''),
(11, 1, NULL, 4000, 'Norie L. De la Cruz', 'Barangay Quatro, Buenavista, Marinduque', 'Buenavista', 'Barangay III', 'Purok 4', 'noriedelacruz@gmail.com', '09243246456', 22, 'Single', 'Filipino', ''),
(12, 1, NULL, 10000, 'Beneden Logmao', 'Mogpog, Marinduque', 'Mogpog', 'Janagdong', 'Purok 4', 'beneden@gmail.com', '09432567689', 20, 'Married', 'Filipino', ''),
(13, 1, NULL, 0, 'Joan Logmao', 'Mogpog Marinduque', 'Mogpog', 'Dawis', 'test street', 'bellie@hulas.co', '09123658794', 21, 'Single', 'sff', ''),
(15, 1, 2, 5000, 'Steve Rogers', 'Poras Boac Marinduque', 'Boac', 'Poras', 'Sanggumay St.', 'steverogers@hulas.co', '09493131426', 21, 'Single', 'Filipino', '');
...
(1, 1, 'Pay day sale', 'Promotion', 'Both', NULL, '0.2', '0.1', 'all customers', '2024-11-30', '2024-12-30', '12'),
(2, 1, '0% Interest Promo', 'Discount', 'Both', NULL, '0.2', '0.2', 'all customers', '2024-11-29', '2024-11-30', '12'),
(3, 1, 'One Day BigTime Sale', 'Promotion', 'Both', NULL, '0', '0.03', 'All Customers', '2024-11-28', '2024-12-28', ''),
